...
BASE_DIR = os.path.dirname(os.path.abspath(__file__))  # path ke folder file ini
csv_path = os.path.join(BASE_DIR, 'kata-dasar-id.csv')  # path absolut ke file CSV

with open(csv_path, 'r', encoding='utf-8') as f:
    WORD_COUNT = Counter(extract_words(f.read()))